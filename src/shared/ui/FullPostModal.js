...
const FullPostModal = ({
  ...
  return (
    <motion.div
      ...
      className="fixed [@media(pointer:coarse)]:hidden top-0 left-0 w-full h-full bg-[#4A5479] dark:bg-black dark:bg-opacity-[50%] bg-opacity-[20%] z-50"
    >
      <motion.div
        layoutId={selectedId}
        className="w-[630px] h-fit mx-auto mt-[86px] dark:bg-[#141414] bg-[#F6F6F8] bottom-0 p-[12px] rounded-[20px]"
      >
