        ...
        {!deleted && (
          ...
          >
            ...
            <div className="flex flex-col relative z-[1] gap-[12px] [@media(hover)]:px-[65px] [@media(pointer:coarse)]:pl-[65px] [@media(pointer:coarse)]:pr-[12px] py-[12px]">
              ...
              <TextMain
                text={textWithLinks}
                style="font-normal whitespace-pre-line text-[16px] lineClampFix overflow-hidden truncate leading-[19px] tracking-[-0.015em] [@media(pointer:coarse)]:text-[15px] [@media(pointer:coarse)]:leading-[18px] [@media(pointer:coarse)]:tracking-[-0.0121875em]"
              />
              {/* header and text */}
