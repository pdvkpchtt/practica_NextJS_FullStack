...
export const MenuButton = ({
  ...
  return (
    <div
      className={`${style} relative  items-center w-full cursor-pointer transition duration-[250ms] bg-[#F4F4F4] dark:bg-[#cfcfcf] dark:hover:bg-[#d4d4d4] dark:hover:bg-opacity-[13%] dark:active:bg-[#f7f7f7] dark:active:bg-opacity-[16%] dark:bg-opacity-[8%] hover:bg-[#E3E3E3] active:bg-[#D2D2D2] p-[16px] flex flex-row justify-between`}
    >
      {borderTop && (
