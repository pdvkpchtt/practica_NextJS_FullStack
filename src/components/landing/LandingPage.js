...
const roadmap = [
  ...
  },
  {
    ...
    content: [
      ...
      //   title: "Расскажите об открытых вакансиях компании в медиа",
      //   text1:
      //     "Вам доступны каналы общения с молодой аудиторией через друзей сервиса — популярных блогеров, артистов и других партнеров",
      //   done: false,
      //   subimg: six2,
      // },
      {
