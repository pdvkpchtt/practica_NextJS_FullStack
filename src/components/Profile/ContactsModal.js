              ...
              {isEdit ? (
                <>
                  <p
                    ...
                    className="text-[#5875e8] select-none hover:text-[#3A56C5] active:text-[#2C429C] cursor-pointer transition duration-[250ms] text-[16px] font-normal leading-[19px] tracking-[-0.24px]"
                  >
                    Отменить изменение
                  </p>
                  <TextSecondary
