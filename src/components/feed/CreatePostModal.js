  ...
  return (
    <>
            ...
            <TextareaAutosize
              ...
              placeholder={
                dropDownState.name === "Офтоп"
                  ...
                  ? "Делитесь новостями компании или  интересными фактами и привлекайте лучших соискателей"
      ...
      <MobileModal isOpen={open} slideToLeft withScroll>
        {/* header */}
        <div className="[@media(pointer:coarse)]:fixed z-[550] [@media(pointer:coarse)]:top-0 [@media(pointer:coarse)]:w-full [@media(pointer:coarse)]:left-0 [@media(pointer:coarse)]:rounded-t-[0px] border-b-[0.7px] border-b-[#E7E7E7] dark:border-b-[#2f2f2f] bg-white dark:bg-[#212122] rounded-t-[20px] p-[12px]">
